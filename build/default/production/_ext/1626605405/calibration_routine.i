# 1 "../lab-6-motors-and-pwm-tomas-thomas.X/calibration_routine.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../lab-6-motors-and-pwm-tomas-thomas.X/calibration_routine.c" 2
...
# 7 "../lab-6-motors-and-pwm-tomas-thomas.X/calibration_routine.c" 2
...
# 8 "../lab-6-motors-and-pwm-tomas-thomas.X/calibration_routine.c" 2



void calibration_general(*temp){
    while(1){
        if(!PORTFbits.RF2){
