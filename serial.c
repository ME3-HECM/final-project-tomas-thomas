...
//    SP4BRGL = 51; 			//set baud rate to 51 = 19200bps or 103 = 9600bps
//    SP4BRGH = 0;			//not used
//
...
//}
//
//void sendSerialRGB(void){ //When called collects the current RGB values and sends them to serial 
//    
//    char senddata[25]; //Empty char to hold string data
//    sprintf(senddata,"Red:%d Green: %d Blue: %d\n",color_read_Red(),color_read_Green(),color_read_Blue()); //values formatted into a string
//    sendStringSerial4(senddata); //Sent using USART
...
void initUSART4(void) {
    ...
    //Baud of 19200
        // formula for our setup 
        //  (64e6 / (64 *(n+1))
        // [ 1e6 / baud ] -1 = n
        // baud = 19200 therefore n = 51.083 = 51
