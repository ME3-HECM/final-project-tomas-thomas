...
SOURCEFILES_QUOTED_IF_SPACED=color.c i2c.c calibration.c dc_motor_v1.c main.c serial.c pathfinder.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/color.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/calibration.p1 ${OBJECTDIR}/dc_motor_v1.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/serial.p1 ${OBJECTDIR}/pathfinder.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/color.p1.d ${OBJECTDIR}/i2c.p1.d ${OBJECTDIR}/calibration.p1.d ${OBJECTDIR}/dc_motor_v1.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/serial.p1.d ${OBJECTDIR}/pathfinder.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/color.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/calibration.p1 ${OBJECTDIR}/dc_motor_v1.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/serial.p1 ${OBJECTDIR}/pathfinder.p1

# Source Files
SOURCEFILES=color.c i2c.c calibration.c dc_motor_v1.c main.c serial.c pathfinder.c
...
${OBJECTDIR}/pathfinder.p1: pathfinder.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/pathfinder.p1.d 
	@${RM} ${OBJECTDIR}/pathfinder.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/pathfinder.p1 pathfinder.c 
	@-${MV} ${OBJECTDIR}/pathfinder.d ${OBJECTDIR}/pathfinder.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/pathfinder.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
